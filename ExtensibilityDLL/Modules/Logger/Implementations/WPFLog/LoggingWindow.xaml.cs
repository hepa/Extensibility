...
//            }            
        ...
        private void CbLoggingLevel_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                case 0:
                    SPTrace_MouseLeftButtonUp(this, null);
                    break;
                case 1:
                    SPDebug_MouseLeftButtonUp(this, null);
                    break;
                case 2: 
                    SPInfo_MouseLeftButtonDown(this, null);
                    break;
                case 3: 
                    SPWarn_MouseLeftButtonUp(this, null);
                    break;
                case 4: 
                    SPError_MouseLeftButtonUp(this, null);
                    break;
                case 5: 
                    SPFatal_MouseLeftButtonUp(this, null);
                    break;
            }
        }
